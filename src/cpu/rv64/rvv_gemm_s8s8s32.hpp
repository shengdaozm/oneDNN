...
*******************************************************************************/
#ifndef CPU_RV64_RVV_GEMM_S8S8S32_HPP
#define CPU_RV64_RVV_GEMM_S8S8S32_HPP
...
struct rvv_gemm_s8s8s32_t : public primitive_t {
    struct pd_t : public ::dnnl::impl::cpu::matmul::cpu_matmul_pd_t {
        using ::dnnl::impl::cpu::matmul::cpu_matmul_pd_t::cpu_matmul_pd_t;

        DECLARE_COMMON_PD_T("RISCV64GCV", rvv_gemm_s8s8s32_t)
...
#endif // CPU_RV64_RVV_GEMM_S8S8S32_HPP
